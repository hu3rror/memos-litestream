...
> ⚠️ **项目状态：仅维持基础维护 / 按现状提供（As-Is）**
>
> - **按现状提供**：本项目目前仅维持极低限度的基础维护（As-Is），不承诺持续开发新功能或修复非致命问题。
> - **不跟进上游大改**：如果 Memos 官方未来发生重大架构调整或破坏性更新（Breaking Changes），**本项目将不再跟进更新**。
> - **数据安全自负**：请自行对个人数据的安全和备份负责。
> - **建议**：如果你需要使用 Memos 的最新功能、希望获得长期稳定的官方更新、或者对数据安全有极高要求，建议自行建立备份方案，并按下方教程 **[迁移回 Memos 官方镜像](#迁移回-memos-官方镜像)**。
